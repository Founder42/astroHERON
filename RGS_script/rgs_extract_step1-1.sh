...
update=""
manual="RGS reprocessing: change the extraction region to a common centroid"
#=========================================
...
for x in "${obsid[@]}"; do
    ...
    rgsproc withsrc=yes srclabel=M104N srcra=189.997458 srcdec=-11.623056 >& cen_rgsproc_log
